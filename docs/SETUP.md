...
```bash
DATA_ACCESS_KEY_ID=<provided_by_owner>
DATA_SECRET_ACCESS_KEY=<provided_by_owner>
```
...
- Make sure your `.env` file has `DATA_ACCESS_KEY_ID` and `DATA_SECRET_ACCESS_KEY`
...
- Try: `uv run streamlit run src/app/streamlit_app.py`
